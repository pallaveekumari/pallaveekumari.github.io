  ...
  return (
    <div className='t-wrapper'>
     ...
     <div className='blur s-blur2' style={{background:"skyblue"}}></div>
      <div className='about'>About myself</div>
    <div className='t-wrapper1'>
...
<p>🤗 I have worked on several different projects collaboratively and solely.
   ...
   chakraUI. Gone through 30 weeks of coding Bootcamp at Masai School.Also, worked on NodeJs, Express, MongoDB DataBase.
